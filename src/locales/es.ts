...
export const es = {
  ...
  theme: 'Tema',
  search: 'Buscar',
  searchPlaceholder: 'Buscar equipos, noticias...',
  ...
  noMatchesAvailable: 'No hay partidos disponibles para esta liga.',
  addTeamsToFavorites: 'Añade equipos a tus favoritos para acceso rápido',
  ...
  matchesWatched: 'Partidos vistos',
  quickAccess: 'Acceso Rápido',
  quickAccessDescription: 'Estos equipos aparecerán en tu página de inicio para acceso rápido:',
  dragToReorder: 'Arrastra para reordenar tus favoritos',
  ...
  // Notifications
  teamAddedToFavorites: 'Equipo añadido a favoritos',
  teamRemovedFromFavorites: 'Equipo eliminado de favoritos',
  ...
  matchScore: 'Resultado del partido',
  sortBy: 'Ordenar por',
  ...
  settings_intro: 'Personaliza tu experiencia en la aplicación',
  previewLightNote: 'Vista previa en modo claro',
  ...
  reduceMotionDesc: 'Minimiza las animaciones en la interfaz',

  notificationSounds: 'Sonidos de notificación',
  matchAlertsTitle: 'Alertas de partidos',
  matchAlertsDesc: 'Goles, tarjetas y eventos importantes',
  favoriteTeamsTitle: 'Equipos favoritos',
  favoriteTeamsDesc: 'Noticias y partidos de tus equipos',
  topNewsTitle: 'Últimas noticias',
  topNewsDesc: 'Noticias destacadas del fútbol',
  weeklySummaryTitle: 'Resumen semanal',
  weeklySummaryDesc: 'Un resumen semanal por email',
  quietHoursTitle: 'Horario silencioso',
  quietHoursDesc: 'Silencia notificaciones durante ciertas horas',

  emailNotificationsTitle: 'Notificaciones por Email',
  emailAddressLabel: 'Dirección de email',
  emailUsageNote: 'Solo se usará para enviar notificaciones de la app',
  emailFrequencyLabel: 'Frecuencia de emails',
  sendTestEmail: 'Probar Email de Notificación',

  successLabel: 'Éxito',
  infoLabel: 'Información',
  warningLabel: 'Aviso',
  errorLabel: 'Error',
  resultTitle: 'Resultado de partido',
  newNewsTitle: 'Noticia nueva',
  reminderTitle: 'Recordatorio',
  connectionFailTitle: 'Fallo en la conexión',
  withActions: 'Notificación con acciones',
  loadingNotification: 'Notificación de carga',

  resetDefaults: 'Restaurar valores por defecto',
  saveChangesBtn: 'Guardar cambios',
  enableQuietHours: 'Activar horario silencioso',
