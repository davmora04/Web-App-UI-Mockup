...
let NewsController = class NewsController {
    ...
    findByTeam(teamId) { return this.newsService.findByTeam(teamId); }
    findBySlug(slug) { return this.newsService.findBySlug(slug); }
    update(id, dto) {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Listar noticias' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Noticias destacadas' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Noticias de un equipo' }),
    __param(0, (0, common_1.Param)('teamId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], NewsController.prototype, "findByTeam", null);
__decorate([
    (0, common_1.Get)(':slug'),
    (0, swagger_1.ApiOperation)({ summary: 'Detalle de noticia' }),
